...
class ConsumablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consumable" do
    assert_difference('Consumable.count') do
      post consumables_url, params: { consumable: { category: @consumable.category, cost: @consumable.cost, name: @consumable.name, pantry_id: @consumable.pantry_id, quantity: @consumable.quantity, unit: @consumable.unit } }
    end
  ...
  test "should update consumable" do
    patch consumable_url(@consumable), params: { consumable: { category: @consumable.category, cost: @consumable.cost, name: @consumable.name, pantry_id: @consumable.pantry_id, quantity: @consumable.quantity, unit: @consumable.unit } }
