...
# rails g scaffold Consumable pantry:belongs_to name:string cost:float unit:string quantity:float category:string => belongs_to Panry??
# rails g scaffold Ingredient recipe:belongs_to consumable:belongs_to quantity:float => will this overpopulate DB???
